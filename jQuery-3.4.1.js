!(function(e, t) {
                        ...
                        return (
                            ...
                            ((a = (C = r).documentElement),
                                ...
                                (d.getById = ce(function(e) {
                                    return (
                                        (a.appendChild(e).id = k), !C.getElementsByName ||
    ...
    k.fn.extend({
        ...
        is: function(e) {
            return !!j(
                this,
                "string" == typeof e && N.test(e) ? k(e) : e || [], !1
            ).length;
        },
    });
    var q,
    ...
    function Ie(n, r, i, o) {
        ...
        if (
            ...
            if (s)
                for (
                    l = a[a.length - 1].ownerDocument, k.map(a, Re), c = 0; c < s; c++
                )
                    (u = a[c]),
                    he.test(u.type || "") &&
    ...
    k.extend({
            ...
            cleanData: function(e) {
                for (
                    var t, n, r, i = k.event.special, o = 0; void 0 !== (n = e[o]); o++
                )
                    if (G(n)) {
                        if ((t = n[Q.expando])) {
                            if (t.events)
        ...
        k.each({
            ...
            function(e, a) {
                k.fn[e] = function(e) {
                    for (
                        var t, n = [], r = k(e), i = r.length - 1, o = 0; o <= i; o++
                    )
