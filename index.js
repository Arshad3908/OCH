$("document").ready(function($) {
        ...
        if ($(window).innerWidth() < 1200) {
            $(".navbar__menu-link").on("click", function(event) {
                if ($(this).siblings(".navbar__submenu").length) {
                    ...
                    $(this)
                        .parent(".navbar__menu-item")
                        .siblings(".navbar__menu-item")
                        .find(".navbar__submenu")
                        .slideUp();
                }
                //return false wont click
                return true;
            });
        } else {
            fixedMenu();
    ...
    if ($(".shop-cart").length) {
        ...
        $(Inc).on("click", function() {
            $(this)
                .siblings(".value")
                .text($(this).siblings(".value").text() * 1 + 1);
        });
    ...
    if ($(".faqs__controls-lists").length) {
        $(".faqs__controls-item").on("click", function() {
            ...
            if (dataValue === "*") {
                ...
                let faqsCardsItems =
                    document.querySelectorAll(".faqs__cards-item");
                for (let i = 0; i < faqsCardsItems.length; i++) {
                    if (
                        faqsCardsItems[i].getAttribute("data-filter2") ===
                        dataValue
                    ) {
        ...
        $(".faqs__cards")
            ...
            .click(function() {
                ...
                $(".faqs__cards")
                    ...
                    .css("border-color", "#f0f0f0");
                $(this)
                    .siblings(".faqs__cards-item")
                    .find(".faqs__cards-item-text")
                    .slideUp();
                $(this)
                    .css("border-color", "#f22283")
                    .find(".faqs__cards-item-text")
